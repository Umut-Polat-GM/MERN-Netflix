                    ...
                    <div className="flex mt-8">
                        <Link
                            ...
                            className="bg-white hover:bg-white/80 text-black font-bold py-2 px-4 rounded mr-4 flex
							 items-center transition-colors duration-150 ease-in-out"
                        >
                        ...
                        <Link
                            to={`/watch/${trendingContent?.id}`}
                            className="bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded flex items-center transition-colors duration-150 ease-in-out"
                        >
